...
// Testing the /api/secrets endpoint

describe('/api/secrets', () => {
  it('should perform a security test for secret tokens leak', async () => {
    await runner
      .createScan({
        tests: [TestType.SECRET_TOKENS_LEAK, TestType.EXCESSIVE_DATA_EXPOSURE, TestType.INSECURE_OUTPUT_HANDLING],
