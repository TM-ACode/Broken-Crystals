...
// Testing the /api/email/getEmails endpoint

describe('/api/email/getEmails', () => {
  it('should perform a security test for excessive data exposure and insecure output handling', async () => {
    await runner
      .createScan({
        tests: [TestType.EXCESSIVE_DATA_EXPOSURE, TestType.INSECURE_OUTPUT_HANDLING],
        name: 'GET /api/email/getEmails - Security Test',
