...
// Testing the JWT login endpoint for security vulnerabilities

describe('/api/auth/jwt/weak-key/login', () => {
  it('should perform a security test on JWT login endpoint', async () => {
    await runner
      .createScan({
        tests: [
