...
// Testing the OPTIONS method for the /api endpoint

describe('/api endpoint OPTIONS method', () => {
  it('should perform a security test for OPTIONS method', async () => {
    await runner
      .createScan({
        tests: [TestType.HTTP_METHOD_FUZZING, TestType.EXCESSIVE_DATA_EXPOSURE, TestType.SECRET_TOKENS_LEAK],
